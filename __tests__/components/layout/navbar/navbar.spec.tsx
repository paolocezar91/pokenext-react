...
jest.mock('@/components/layout/navbar/menu-md', () => jest.fn(({ }) => <div data-testid="default-menu">{}</div>));
jest.mock('@/components/layout/navbar/menu-xs', () => jest.fn(({ }) => <div data-testid="mobile-menu">{}</div>));
