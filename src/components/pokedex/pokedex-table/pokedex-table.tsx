...
export default function PokedexTable({ pokemons }: { pokemons: IPkmn[] }) {
  ...
  useEffect(() => {
    const sortingValues =
      settings && Array.isArray(settings.sorting) ? settings.sorting : [];
